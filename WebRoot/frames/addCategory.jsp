...
<form action="${pageContext.request.contextPath}/shop/addCategory_CommodityAction" method="post">
	...
	<div style="width: 80%;margin-left: 10%;">
		...
		<div style="width: 100%;float: left">
			...
			<div style="width: 70%;float:left">
				<input type="text" class="form-control" name="category.categoryRemark" />
			</div>
		</div>
	</div>
