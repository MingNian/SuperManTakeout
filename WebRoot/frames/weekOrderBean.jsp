	...
	<head>
		...
		<script type="text/javascript">
			function toPage(pageNum){
				window.location.href="shop/preWeek_OrderBeanAction?currPage="+pageNum;
			}
		</script>
	</head>
	<body>
		<div id="div0">
			<div id="div_main">
			<div id="div_title">最近一周订单</div><br/>
				<div id="div_tbl">
						<table id="tbl" border="1" style="width:96%;">
							...
							<c:choose>
								...
								<c:otherwise>
									<c:set var="i" value="0"/>
									<c:forEach items="${orderBeans5}" var="orderBean">
