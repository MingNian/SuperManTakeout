	...
	<head>
		...
		<script type="text/javascript">
			function toPage(pageNum){
				window.location.href="shop/preToday_OrderBeanAction?currPage="+pageNum;
			}
		</script>
	</head>
	<body>
				...
				<div id="div_tbl">
						<table id="tbl" border="1" style="width:96%;">
							...
							<c:choose>
								...
								<c:otherwise>
									<c:set var="i" value="0"/>
									<c:forEach items="${orderBeans4}" var="orderBean">
